...
const WorkListItemDetail = ({ item, onClose, onUpdate }) => {
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      ...
      case 'low': return 'bg-gray-100 dark:bg-neutral-700 text-gray-800 dark:text-neutral-100 border-gray-300 dark:border-neutral-700';
      default: return 'bg-gray-100 dark:bg-neutral-700 text-gray-800 dark:text-neutral-100 border-gray-300 dark:border-neutral-700';
    }
  };
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
        <div className="bg-white dark:bg-neutral-950 rounded-lg dark:border dark:border-neutral-700 p-6">
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-neutral-950 rounded-xl shadow-xl dark:shadow-neutral-950/50 dark:border dark:border-neutral-700 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-neutral-950 border-b border-gray-200 dark:border-neutral-700 px-6 py-4 flex justify-between items-start">
        ...
        <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                {details.relatedItems.map((related, idx) => (
                  <div key={idx} className="bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-700 rounded-lg p-3">
                    {related.full_name && (
            ...
            <div>
              ...
              <div className="space-y-2">
                {details.history.map((entry) => (
                  <div key={entry.id} className="bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-700 rounded-lg p-3">
          ...
          {item?.metadata && (
            <div>
              ...
              <pre className="bg-gray-50 dark:bg-neutral-950 border border-gray-200 dark:border-neutral-700 rounded-lg p-3 text-xs overflow-auto text-gray-900 dark:text-neutral-100">
