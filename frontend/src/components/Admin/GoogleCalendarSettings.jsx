...
const GoogleCalendarSettings = () => {
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-neutral-950 rounded-lg shadow-md dark:shadow-neutral-950/50 dark:border dark:border-neutral-700 p-4">
  ...
  return (
    <div className="bg-white dark:bg-neutral-950 rounded-lg shadow-md dark:shadow-neutral-950/50 dark:border dark:border-neutral-700 p-4 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            onClick={loadStatus}
            disabled={working}
            className="px-3 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-800 text-gray-900 dark:text-neutral-100 text-sm"
          >
            Refresh
          </button>
          {status.connected ? (
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              {selectedSyncIds.length > 0 && (
                <p className="text-xs text-gray-600 dark:text-neutral-100 bg-gray-50 dark:bg-neutral-950 rounded px-2 py-1">
