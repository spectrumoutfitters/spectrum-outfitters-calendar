    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {products.map(product => (
          <div key={product.id} className="bg-white dark:bg-neutral-900 rounded-lg shadow-md dark:shadow-neutral-950/50 overflow-hidden border border-gray-200 dark:border-neutral-700">
            {product.image_url && (
              <img
            ...
            <div className="p-4">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className={`px-2 py-1 rounded text-xs ${
                  product.is_active === 1 ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-gray-100 dark:bg-neutral-700 text-gray-800 dark:text-neutral-200'
                }`}>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-neutral-900 rounded-lg dark:border dark:border-neutral-700 p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
