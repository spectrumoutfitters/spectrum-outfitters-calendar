    ...
    <div className="space-y-6">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {salesEntries.map((entry) => {
                    ...
                    return (
                      <tr key={entry.id} className={`border-t border-gray-200 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800 ${entry.no_sales ? 'bg-gray-50 dark:bg-neutral-950/50' : ''}`}>
                        <td className="py-3 px-4">
                          {formatDate(entry.sale_date)}
                          {entry.no_sales ? (
                            <span className="ml-2 text-xs bg-gray-200 dark:bg-neutral-700 text-gray-600 dark:text-neutral-100 px-2 py-0.5 rounded">No Sales</span>
                          ) : null}
                        </td>
              ...
              <tbody>
                {dashboard?.obligations?.map((ob) => (
                  <tr key={ob.id} className="border-t border-gray-200 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800">
                    ...
                    <td className="py-3 px-4">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${ob.enabled ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-gray-100 dark:bg-neutral-700 text-gray-600 dark:text-neutral-100'}`}>
      ...
      {showSalesModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-2 sm:p-4">
          <div className="bg-white dark:bg-neutral-950 rounded-lg shadow-xl dark:shadow-neutral-950/50 dark:border dark:border-neutral-700 w-full max-w-2xl max-h-[95vh] flex flex-col">
            {/* Fixed Header */}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-7 pr-3 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-950 text-gray-900 dark:text-neutral-100 text-lg font-semibold"
                        placeholder="0.00"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-7 pr-3 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-950 text-gray-900 dark:text-neutral-100"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-5 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 border border-gray-300 dark:border-neutral-700 rounded text-sm bg-white dark:bg-neutral-950 text-gray-900 dark:text-neutral-100"
                      placeholder="0.00"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-7 pr-3 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg bg-green-100 dark:bg-green-900/30 text-gray-900 dark:text-neutral-100"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
